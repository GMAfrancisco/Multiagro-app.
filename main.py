...
st.markdown(f"""
    <div class="header-banner">
        ...
        <p style="color: #E0E0E0; font-size: 1.2rem;">División AgTech | Grupo Multiagro</p>
    </div>
    """, unsafe_allow_html=True)

cultivo_input = st.text_input("¿Qué cultivo o planta estamos analizando?", placeholder="Ej: Tomate, Arroz...")
